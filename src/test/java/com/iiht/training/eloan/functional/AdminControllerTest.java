...
public class AdminControllerTest {
	...
	@Test
	public void testRegisterClerkIsServiceMethodCalled() throws Exception {
	...
	@Test
	public void testGetAllClerksIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		List<UserDto> userDtos = MasterData.getUserDtoList();
	...
	@Test
	public void testRegisterManagerIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		UserDto userDto = MasterData.getUserDto();
		UserDto savedUserDto = MasterData.getUserDto();
		savedUserDto.setId(1L);
	...
	@Test
	public void testGetAllManagersIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		List<UserDto> userDtos = MasterData.getUserDtoList();
	...
	@Test
	public void testDisableManagerIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		UserDto userDto = MasterData.getUserDto();
	...
	@Test
	public void testEnableManager() throws Exception {
		UserDto userDto = MasterData.getUserDto();
	...
	@Test
	public void testEnableManagerIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		UserDto userDto = MasterData.getUserDto();
	...
	/**********Clerk*******************/
	@Test
	public void testDisableClerk() throws Exception {
		UserDto userDto = MasterData.getUserDto();
	...
	@Test
	public void testDisableClerkIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		UserDto userDto = MasterData.getUserDto();
	...
	@Test
	public void testEnableClerk() throws Exception {
		UserDto userDto = MasterData.getUserDto();
	...
	@Test
	public void testEnableClerkIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		UserDto userDto = MasterData.getUserDto();
	...
	@Test
	public void testDisableCustomerIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		UserDto userDto = MasterData.getUserDto();
	...
	@Test
	public void testEnableCustomerIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		UserDto userDto = MasterData.getUserDto();
